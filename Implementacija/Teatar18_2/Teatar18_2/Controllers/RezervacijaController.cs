...
namespace Teatar18_2.Controllers
{
    public class RezervacijaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,kupovina,brojKarata,popust")] Rezervacija rezervacija)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,kupovina,brojKarata,popust")] Rezervacija rezervacija)
        {
